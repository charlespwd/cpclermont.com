...
get the app created:
    ...
    $ heroku apps:create cpclermont
    Creating cpclermont... done, stack is cedar
    http://cpclermont.herokuapp.com/ | git@heroku.com:cpclermont.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://cpclermont.herokuapp.com deployed to Heroku

    To git@heroku.com:cpclermont.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://cpclermont.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@cpclermont.herokuapp.com/repl
