(function($) {
  ...
  $(function() {
    ...
    $('input#contact-send').click(function(e) {
      $.post('/contact', $('form#contact-form').serialize(), function(data, status) {
        if (status === 'success') {
          swal('Great job!', 'Your message was sent. I will reply to you shortly.', 'success');
        } else {
          swal('Un oh!', 'We couldn\'t send your message. I\'ll be looking into this issue shortly', 'error');
        }
      });
      e.preventDefault();
    });
